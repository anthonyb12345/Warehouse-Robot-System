...
#include "warehouse_robot/srv/detail/check_stock__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = warehouse_robot::srv::CheckStock_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const warehouse_robot::srv::CheckStock_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<warehouse_robot::srv::CheckStock_Request *>(
    untyped_ros_message);
...
{
  return &warehouse_robot::srv::typesupport_fastrtps_cpp::_CheckStock_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = warehouse_robot::srv::CheckStock_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const warehouse_robot::srv::CheckStock_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<warehouse_robot::srv::CheckStock_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &warehouse_robot::srv::typesupport_fastrtps_cpp::_CheckStock_Response__handle;
}
...
{
  return &warehouse_robot::srv::typesupport_fastrtps_cpp::_CheckStock__handle;
}
